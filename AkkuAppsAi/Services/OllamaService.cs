...
{
    Task<string> GetResponseAsync(string prompt, string model, List<string>? imageBase64s = null, OllamaOptions? options = null, string? systemPrompt = null);
    Task<List<string>> GetAvailableModelsAsync();
    IAsyncEnumerable<string> GetStreamingResponseAsync(string prompt, string model, OllamaOptions? options = null, string? systemPrompt = null, CancellationToken cancellationToken = default);
}
...
public class OllamaService : IOllamaService
{
    ...
    public async Task<string> GetResponseAsync(string prompt, string model, List<string>? imageBase64s = null, OllamaOptions? options = null, string? systemPrompt = null)
    {
    ...
    public async IAsyncEnumerable<string> GetStreamingResponseAsync(string prompt, string model, OllamaOptions? options = null, string? systemPrompt = null, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        options ??= new OllamaOptions();
        var payload = new Dictionary<string, object>
        {
